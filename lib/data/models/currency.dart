...
class Currency {
  ...
  Currency.usd() {
    ...
    icon = SvgPicture.asset('assets/currency_dollar_fee_money_icon.svg', color: const Color.fromRGBO(0, 60, 143, 0.8), width: 24,);
    name = "Долар США";
    symbol = "USD";
    rateToUah = 27.3317;
  }
  ...
  Currency.uah() {
    ...
    icon = SvgPicture.asset('assets/hryvnia_sign_icon.svg', color: const Color.fromRGBO(0, 60, 143, 0.8), width: 24,);
    name = "Гривня";
    symbol = "UAH";
    rateToUah = 1;
  }
