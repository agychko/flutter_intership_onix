    ...
    try {
      ...
      return Future.delayed(
        ...
        () => DataResponse.success(<CurrencyEntity>[
          CurrencyEntity(0, 'https://flagcdn.com/w80/ua.png', '₴', 'Ukrainian Hryvna',
          ...
          CurrencyEntity(
              ...
              'EUR',
              rates.eUR!.toDouble()),
          CurrencyEntity(2, 'https://flagcdn.com/w80/us.png', '\$', 'American Dollar',
              'USD', rates.uSD!.toDouble()),
          CurrencyEntity(3, 'https://flagcdn.com/w80/pl.png', 'zł', 'Polish Zloty',
              'PLN', rates.pLN!.toDouble()),
          CurrencyEntity(4, 'https://flagcdn.com/w80/cz.png', 'Kč', 'Czech Crown',
              'CZK', rates.cZK!.toDouble()),
          CurrencyEntity(5, 'https://flagcdn.com/w80/ru.png', '₽', 'Russian Ruble',
              'RUB', rates.rUB!.toDouble()),
          CurrencyEntity(6, 'https://flagcdn.com/w80/gb.png', '£', 'Pound Sterling',
          ...
          CurrencyEntity(9, 'https://flagcdn.com/w80/jp.png', '¥', 'Japanese Yen',
              'JPY', rates.jPY!.toDouble()),
          CurrencyEntity(10, 'https://flagcdn.com/w80/cn.png', '¥', 'Chinese Yuan',
