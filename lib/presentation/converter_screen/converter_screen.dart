                ...
                child: BlocBuilder<ConverterBloc, ConverterState>(
                  ...
                  if (state is ConverterError) {
                    return ErrorMessage(
                      error: state.error,
                      onTap: () =>
                          context.read<ConverterBloc>().add(GetConverterData()),
                    );
                  }
                  if (state is ConverterSuccess) {
                    ...
                    return SlideTransition(
                      ...
                      child: CurrencyCard(
                        currency: state.converter.currencyTop,
                        controller: context.read<ConverterBloc>().topController,
                        onChanged: (currency) {
                          context
                              .read<ConverterBloc>()
                              .add(CurrencyTopChanged(currency));
                        },
                        onInputValueChanged: (value) {
                          context.read<ConverterBloc>().add(Convert(value));
                        },
                      ),
                    );
                  }
                ...
                child: BlocBuilder<ConverterBloc, ConverterState>(
                  ...
                  if (state is ConverterSuccess) {
                    return SlideTransition(
                      ...
                      child: CurrencyCard(
                        currency: state.converter.currencyDown,
                        controller:
                            context.read<ConverterBloc>().bottomController,
                        onChanged: (currency) {
                          context
                              .read<ConverterBloc>()
                              .add(CurrencyDownChanged(currency));
                        },
                        onInputValueChanged: (value) {
                          context.read<ConverterBloc>().add(ConvertBack(value));
                        },
                      ),
                    );
                  }
